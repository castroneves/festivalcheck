...
public class ReccoFirstPreferenceStrategyTest {

    private ReccoFirstPreferenceStrategy strategy = new ReccoFirstPreferenceStrategy();

    @Test
    public void recommendedArtistsFavouredOverListened() {
